...
<div class="container mx-auto">
    <div class="mb-4 mt-10 flex justify-between items-center">
                ...
                <tbody>
                    ...
                    <tr class="{{ $index % 2 == 0 ? 'bg-gray-200' : 'bg-white' }}" data-name="{{ strtolower($supplier->name) }}">
                        ...
                        <td class="border px-2 py-2 w-1/12 text-center">
                            <a href="" class="bg-yellow-500 text-white px-2 py-1 rounded inline-flex"><x-eva-edit-outline style="height: 20px; width: 20px;" /></a>
                        </td>
                        <td class="border px-2 py-2 w-1/12 text-center">
        ...
        <div class="mt-4 mr-12 flex justify-end">
            <button type="submit" id="delete-button" class="bg-red-500 text-white px-4 py-2 rounded opacity-50 cursor-not-allowed" disabled>
